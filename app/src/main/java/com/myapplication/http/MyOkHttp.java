...
import com.myapplication.http.body.ProgressRequestBody;
import com.myapplication.http.body.ResponseProgressBody;
import com.myapplication.http.response.DownloadResponseHandler;
import com.myapplication.http.response.GsonResponseHandler;
import com.myapplication.http.response.IResponseHandler;
import com.myapplication.http.response.JsonResponseHandler;
...
/**
 * 封装好的MyOkhttp
 * Created by wangxiaotao on 16/8/15.
 */
