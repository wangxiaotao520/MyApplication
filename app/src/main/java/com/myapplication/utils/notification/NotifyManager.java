...
public class NotifyManager {
    ...
    private void createNotificationChannel(@NonNull ChannelEntity channelEntity, @Nullable String groupId) {
        ...
        if (channelEntity.getSound()!=Settings.System.DEFAULT_NOTIFICATION_URI){
            channel.setSound(channelEntity.getSound(),channel.getAudioAttributes());
        }
    ...
    private int getRandomId() {
        return random.nextInt(50000)+(int)System.currentTimeMillis();
    }
